...
$Bneanderx$O:	$Bneanderx.c;	$(CC) $(CFLAGS) -c -Isrc -o $@ $Bneanderx.c
...
$Bneanderx.c:	$Blburg$E src/neanderx.md; $Blburg src/neanderx.md $@
...
clean::		testclean
		$(RM) $B*$O
		$(RM) $Bdagcheck.c $Balpha.c $Bmips.c $Bx86.c $Bsparc.c $Bx86linux.c $Bneanderx.c
